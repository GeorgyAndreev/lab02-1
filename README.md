...
# переход в нужную директорию и выполнение файла activate
```ShellSession
$ cd ${GITHUB_USERNAME}/workspace
$ source scripts/activate
```

# создание новой директории и запись в файл до EOF, далее ввод параметров гит
```ShellSession
$ mkdir ~/.config
$ cat > ~/.config/hub <<EOF
github.com:
...
# создание новой директории с последующим переходом в нее, инициализация гит репозитория(создание необходимых файлов гит репозитория)
# ввод параметров(почта, имя), добавление нового удаленного гит репозитория и его заполнение последней версией кода в master
# создание файла, коммит этого файла, загрузка изменений в ветку master
```ShellSession
...
int main() {
    std::string name; // will keep your name
    std::cout << "enter your name" << std::endl; // asking for your name
    std::cin >> name;
    std::cout << std::endl << "hello world" << std::endl;
}
EOF
...
# $ git commit -m"Mozilla style" $ git push origin patch2
